...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmlsbGlwaSIsImEiOiJjazJ4cWZ0Ym4wMDNvM2lxeGxuamh1cWpqIn0.nF-uU7VOSwYRTpRtkijMRw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/fillipi/ck2xql06309851cp881yagpw1',
...
var updateData = function updateData(data, type) {
  var url, res;
...
var updateLoginForm = document.querySelector('.form-user-data');
...
if (updateLoginForm) {
  updateLoginForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function _callee(e) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return regeneratorRuntime.awrap((0, _updateSettings.updateData)({
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38581" + '/');
